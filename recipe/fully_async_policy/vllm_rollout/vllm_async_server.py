...
class vLLMHttpServerForPartial(vLLMHttpServerBase):
    ...
    async def _generate_step(
        ...
        # sampling_params is already a SamplingParams object, just update properties
    ...
    async def generate_for_partial(
        ...
        # Convert dict to SamplingParams object
        ...
        async with self.lock:
            ...
            turn_logprobs = self.req_output[request_id].outputs[0].logprobs[0]
        ...
        return token_ids, log_probs, is_cancel, turn_logprobs
