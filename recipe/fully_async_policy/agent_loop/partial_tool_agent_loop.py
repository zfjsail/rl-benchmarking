...
class AsyncPartialToolAgentLoop(ToolAgentLoop):
    ...
    async def _handle_generating_state_partial(
        ...
        turn_logprobs = None  # Initialize to store turn_logprobs
        ...
        with simple_timer("generate_sequences", agent_data.metrics):
            ...
            if self.enable_partial_rollout:
                ...
                response_ids, log_probs, is_cancel, turn_logprobs = await self.server_manager.generate_for_partial(
                ...
                if is_cancel:
                    ...
                    agent_data.all_logprobs.append(turn_logprobs)
                    if log_probs:
                ...
                turn_logprobs = output[0].logprobs[0]
