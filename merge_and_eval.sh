...
for step in {800..900..50}; do
    # python -m verl.model_merger merge \
    #     --backend fsdp \
    #     --local_dir outputs/multiturn_grpo_v5_ce/global_step_${step} \
    #     --target_dir outputs/multiturn_grpo_v5_ce/global_step_${step}/huggingface
    find outputs/multiturn_grpo_v4_old/global_step_${step} -type f -name "*.pt" -delete   # 删除保存文件的所有pt文件
