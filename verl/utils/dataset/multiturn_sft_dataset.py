...
class MultiTurnSFTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        with open('debugger.pkl', 'wb') as f:
            import pickle
            pickle.dump({'concat_tokens': concat_tokens, 'concat_loss_mask': concat_loss_mask, 'concat_attention_mask': concat_attention_mask, 'full_tokens': full_tokens[0].tolist()}, f)
        exit(0)
