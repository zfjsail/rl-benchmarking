...
class AgentData:
    ...
    def __init__(
        ...
        all_logprobs: Optional[list[dict[int, list[float]]]] = None,
    ):
        ...
        self.interaction_additional_data: list[dict[str, Any]] = []
        self.all_logprobs: list[dict[int, list[float]]] = []
        self.user_turns = 0
...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        output.extra_fields.update({
            ...
            "all_logprobs": agent_data.all_logprobs,
            "interaction_additional_data": agent_data.interaction_additional_data,
        })
        return output
    ...
    async def _handle_generating_state(
        ...
        if output.turn_logprobs:
            agent_data.all_logprobs.append(output.turn_logprobs)
    ...
    async def _handle_interacting_state(self, agent_data: AgentData) -> AgentState:
        ...
        (
            ...
            agent_data.request_id, agent_data.messages,agent_data.all_logprobs, **agent_data.interaction_kwargs
        )
        agent_data.user_turns += 1

        # Store additional data from interaction if available
        if additional_data:
            agent_data.interaction_additional_data.append(additional_data)
